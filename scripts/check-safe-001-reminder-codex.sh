#!/usr/bin/env bash
# check-safe-001-reminder-codex.sh - Codex UserPromptSubmit wrapper around
# check-safe-001-reminder.sh.
#
...
check="$repo_root/_sub/agent-base/template/scripts/check-safe-001-reminder.sh"
[[ -f "$check" ]] || exit 0
