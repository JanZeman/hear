...
screening — but the player experiences it purely as a game, for players of any age, never as a
medical test.

This is a personal project by Jan Zeman, developed independently in free time. It is not
affiliated with any employer's product line.
