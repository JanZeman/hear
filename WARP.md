...
Warp adapter for this repository.
...
```bash
AGENT_BASE_VENDOR=warp bash "$(git rev-parse --show-toplevel)/agent-base-guard.sh"
```
...
Keep only vendor-specific Warp content outside this managed block.
